Feature: Checkout process
  ...
  #  And I click "Mr/Mrs" button
    ...
    #Then I'm on the payment page
   # Given I switched to "iFrameName" iFrame
    When I enter "Card Number" to the "Card" iframe field
    And I enter "Card Name" to the "CardName" field